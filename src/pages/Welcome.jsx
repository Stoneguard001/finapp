    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-slate-100">FinApp</h1>
          <p className="mt-2 text-slate-400">Personal budgeting — your data stays yours.</p>
        </div>
        ...
        <div className="card space-y-3">
          ...
          >
            ...
            <div>
              <div className="font-medium text-slate-100">New Database</div>
              <div className="text-xs text-slate-400">Start fresh — create a new .sqlite file</div>
            </div>
          </button>

          <button
            onClick={handleOpen}
            className="w-full flex items-center gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700/50
          ...
          >
            ...
            <div>
              <div className="font-medium text-slate-100">Open Database</div>
              <div className="text-xs text-slate-400">Load an existing .sqlite file from anywhere</div>
            </div>
          </button>
        </div>
